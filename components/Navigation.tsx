    ...
    <div className="flex items-center justify-between h-16">
      <div className="flex items-center">
        <div className="flex-shrink-0">
          <span className="text-2xl font-bold text-slate-900">Pulse Fitness</span>
        </div>
      </div>
      ...
      <div className="hidden md:block">
        <div className="ml-10 flex items-center space-x-8">
          ...
          <a href="#get-started" className="bg-blue-600 text-white px-5 py-2 rounded-md text-sm font-medium hover:bg-blue-700 transition-colors">
            Get Started
          </a>
        </div>
      </div>
